...
/** 화면에 보여줄 “YYYY.MM.DD ~ YYYY.MM.DD” 문자열 만들기 */
...
/** 시작/종료일을 기준으로 D-n / D-DAY / 종료 라벨 생성 */
    ...
    const load = async () => {
      try {
        ...
        const sorted = [...mapped].sort((a, b) => {
          const aDate = parseDateString(a.startDate ?? a.endDate);
          const bDate = parseDateString(b.startDate ?? b.endDate);
